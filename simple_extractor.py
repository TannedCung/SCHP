...
dataset_settings = {
    ...
    'cihp': {
        'input_size' : [473, 473],
        'num_classes': 20,
        'label': ['Background', 'Hat', 'Hair', 'Sunglasses', 'Upper clothes', 'Dress', 'Coat', 'Socks', 'Pants', 'Gloves', 'Scarf',
                  'Skirt', 'Torsoskin', 'Face', 'Right arm', 'Left arm', 'Right leg', 'Left leg',' Right shoe', 'Left shoe']
    }
}
...
def main():
    ...
    with torch.no_grad():
        ...
        print("Processed {} images using {:.5} seconds, average each image took {:.5} seconds".format(count, end-start, (end-start)/count))
    return
