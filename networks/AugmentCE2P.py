...
class PSPModule(nn.Module):
    ...
    def __init__(self, features, out_features=512, sizes=(1, 2, 3, 6)):
        ...
        self.stages = []
        # self.al_ABN_PSP = al_ABN(out_features)
        # print(self._make_stage(features, out_features, 2))
...
class ASPPModule(nn.Module):
    ...
    def __init__(self, features, inner_features=256, out_features=512, dilations=(12, 24, 36)):
        ...
        # self.al_ABN_ASPP = al_ABN(inner_features)
        # self.al_ABN_btn = al_ABN(out_features)
        self.conv1 = nn.Sequential(nn.AdaptiveAvgPool2d((1, 1)),
                                   nn.Conv2d(features, inner_features, kernel_size=1, padding=0, dilation=1,
                                             bias=False),
                                   al_ABN(inner_features))
...
class Edge_Module(nn.Module):
    ...
    def __init__(self, in_fea=[256, 512, 1024], mid_fea=256, out_fea=2):
        ...
        # self.al_ABN_Edge = al_ABN(mid_fea)
...
class Decoder_Module(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        # self.al_ABN_1 = al_ABN(256)
        # self.al_ABN_2 = al_ABN(48)
        # self.al_ABN_3 = al_ABN(256)
        self.conv1 = nn.Sequential(
